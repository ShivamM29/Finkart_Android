...
class Constants {
    companion object{
        ...
        const val BASIC_PLAN_PERCENT_ANNUAL = 37
        const val MASTER_PLAN_PERCENT_ANNUAL = 42
        const val ADVANCE_PLAN_PERCENT_ANNUAL = 45

        const val BASIC_PLAN_PERCENT_MONTHLY = 3.08
        const val MASTER_PLAN_PERCENT_MONTHLY = 3.5
        const val ADVANCE_PLAN_PERCENT_MONTHLY = 3.75

        const val PLAN_BASIC_START_PRICE = 1000
        const val PLAN_BASIC_END_PRICE = 49999

        const val PLAN_MASTER_START_PRICE = 50000
        const val PLAN_MASTER_END_PRICE = 249999

        const val PLAN_ADVANCE_START_PRICE = 250000
        const val PLAN_ADVANCE_END_PRICE = 1000000
    }
}