...
import com.investment.finkart.databinding.FragmentLoginBinding
import com.investment.finkart.databinding.LoginBottonSheetBinding
                        ...
                        if (Constants.RESPONSE_CREATED == data.subCode || Constants.RESPONSE_SUCCESS == data.subCode){
                            ...
                            if (token != null){
                                ...
                                if (data.items.isOnboarded) {
                                    ...
                                    startActivity(Intent(context, com.investment.finkart.MainActivity::class.java))
                                    activity?.finish()
                                }else{
